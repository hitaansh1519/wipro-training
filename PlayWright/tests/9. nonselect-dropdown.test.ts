...
test.only('Non select dropdown', async ({ page }) => {
    await page.goto('http://127.0.0.1:5500/PlayWright/practice-websites/practice-nonselect.html')
...
test('Non select dropdown1', async ({ page }) => {
    ...
    //I still have to write a weight even when I'm calling the function. It's a must. 
...
test.only('Non-editable textbox', async ({ page }) => {
